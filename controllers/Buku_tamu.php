...
class Buku_tamu extends CI_Controller
{
	...
	foreach ($this->M_buku_tamu->get_all() as $data) {
            $kolombody = 0;
    ...
    public function word()
    {
        ...
        $data = array(
            'tb_buku_tamu_data' => $this->M_buku_tamu->get_all(),
            'start' => 0
        );
        
        $this->load->view('buku_tamu/tb_buku_tamu_doc',$data);
    }
...
/* Generated by Harviacode Codeigniter CRUD Generator 2020-06-29 07:33:25 */
/* http://harviacode.com */